...
### Import data
Now we import the data. An OnDiskMSnExp object (`all_data`) was created from mzML files with an associated phenodata (i.e. metadata) table. 


```{r import data}
#load data object
fp <- system.file('extdata/data_MSnExp.rda', package = 'GlycoAnnotateR')
load(fp)

#print phenodata dataframe
pData(all_data)
```
